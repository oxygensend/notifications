...
notifications:
  ...
  services: # list of whitelisted services eg., ignore if auth-enabled: false
    ...
    - "messaging-service"
  auth:
    enabled: true # if authentication and authorization enabled, default: true
    secret: # password that will be used for notification's authentication, ignore if auth-enabled: false
    hash-algorithm: # algorithm use for authentication, NONE, SHA256, default: NONE
